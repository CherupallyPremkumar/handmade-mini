...
import type { ServerBanner, ServerCategory } from '@/lib/server-fetch';
...
export default function HomeContent({ banners, scrollSeconds, categories, featured }: HomeContentProps) {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {featured.length === 0 ? (
            <div className="text-center py-12">
              <p className="font-body text-bark-light">No sarees available right now. Check back soon!</p>
            </div>
          ) : (
